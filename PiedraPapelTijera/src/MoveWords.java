...
public class MoveWords {
	...
	public static int checkWinner(String first, String second) {
		...
		if (first.equals("TIJERAS") && second.equals("LAGARTIJA"))
			return GANA;
		if (first.equals("PAPEL") && second.equals("SPOCK"))
			return GANA;
		if (first.equals("PIEDRA") && second.equals("LAGARTIJA"))
			return GANA;
		if (first.equals("SPOCK") && second.equals("PIEDRA"))
			return GANA;
		if (first.equals("LAGARTIJA") && second.equals("PAPEL"))
			return GANA;
